...
#source_port=hex(randrange(49152,65535,1))[2:] #Random port from dynamic ports
source_port = '3030'
#-------check sum-----

def chkk(values):
	#----convert the hex to binary of 16 bits zfill(16)----
	#- As i am filling the MSF-> zeros-----
	#- 0x6 = 0b110 fill the left side reaming with zeros.
	#- 110 will look like 0000000000000110  ---16bit number.
	#- zfill(8)--> 8 bit, zfill(32)--> 32 bit, and so on.
	#- x=bin(int(values,16))[2:].zfill(16)
	
	#- added 0b to 0000000000000110 --> 0b0000000000000110 now this is binary number.
	#- return "0b"+x
